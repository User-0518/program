...
type
  TDataModule2 = class(TDataModule)
    ...
    ADOTable4Датарождения: TDateTimeField;
    ADOTable4Местопрописки: TWideStringField;
    ADOTable4Местопроживания: TWideStringField;
    ADOTable4Составсемьи: TWideMemoField;
